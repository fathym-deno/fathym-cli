...
export interface PromptService {
  Input(message: string, options?: Omit<InputOptions, 'message'>): Promise<string>;
...
export class CliffyPromptService implements PromptService {
  public async Input(message: string, options?: Omit<InputOptions, 'message'>): Promise<string> {
