 ...
 * direct package specifiers (e.g., `jsr:@fathym/common@0.2.310-common-release/merge`) and
...
export class DepsFileParser {
   ...
   *
   * @param specifier - A specifier string like 'jsr:@fathym/common@0.2.310-common-release/merge'
