 ...
 * direct package specifiers (e.g., `jsr:@fathym/common@0.2.299/merge`) and
...
export class DepsFileParser {
   ...
   *
   * @param specifier - A specifier string like 'jsr:@fathym/common@0.2.299/merge'
   * @returns Parsed reference or null if the specifier is invalid
   */
  parseSpecifier(specifier: string): Omit<DepsReference, 'line' | 'column'> | null {
